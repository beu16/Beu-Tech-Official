...
export const translations: Record<"en" | "am", Translation> = {
  en: {
    ...
    langToggle: "አማርኛ",
    exploreCompanies: "See What We Build",
    startProject: "Start a Project",

    heroTitle: "",
    heroSubtitle: "From websites to hospital and hotel management, and any system your organization can imagine. Designed, built and supported by one dedicated team.",
    ...
    whyTitle: "Built Around How Your Business Works",
    whyCard1Title: "Local Insight, Global Standards",
    whyCard1Desc: "Shaped by markets that move fast, engineered to international standards and built to keep working on unreliable connections.",
    whyCard2Title: "Fast & Modern",
    whyCard2Desc: "Modern, proven technology running on fast and scalable cloud infrastructure.",
    whyCard3Title: "Secure & Reliable",
    whyCard3Desc: "Strong encryption, secure access and automatic backups keep your data safe at every step.",
    whyCard4Title: "Support That Speaks Your Language",
    whyCard4Desc: "English and Amharic support by phone, email and Telegram, across time zones.",

    stat1Label: "Industries We Build For",
    ...
    test2Text: "\"The QR menu system from Beu Tech transformed our restaurant. Customers love it, and orders are faster.\"",
    test2Author: "Sara M., Restaurant Manager, Bole",
    test3Text: "\"Beu Tech built our entire inventory system from scratch. Professional, fast, and exactly what we needed.\"",
    test3Author: "Dawit T., Wholesale Distributor",

    contactSectionTitle: "Ready to Build Something Great?",
    contactSectionSubtitle: "A website, a hospital system, a hotel platform or something completely new. Tell us what you need and we will build it.",
    ...
    contactEmail: "Email: infobeutech@gmail.com",
    contactLocation: "Addis Ababa, Ethiopia",

    aboutStoryTitle: "Our Story",
    aboutStoryText1: "Beu Tech is an Ethiopian software startup founded with one clear mission, to accelerate digital transformation. Instead of selling the same product to everyone, we listen to what each organization needs and build exactly that, from websites and hospital and hotel systems to school platforms, point of sale and anything else our clients ask for.",
    aboutStoryText2: "We bring together skilled local engineers, modern development practices and a deep understanding of how businesses really work. From small merchants in Merkato to large hotels in Addis Ababa, the systems we build are robust, secure and fast.",
    aboutMissionTitle: "Our Mission",
    aboutMissionText: "To build reliable, scalable and beautifully designed software that helps organizations grow, wherever they operate.",
    aboutVisionTitle: "Our Vision",
    aboutVisionText: "Starting at home in Ethiopia and growing outward, we aim to become a trusted engine of digital transformation that makes smart and secure software available to every organization.",
    aboutValuesTitle: "Our Core Values",
    aboutValue1Title: "Innovation with Purpose",
    aboutValue1Desc: "We never build technology for its own sake. Every line of code has to solve a real problem for a real business.",
    aboutValue2Title: "Absolute Integrity",
    aboutValue2Desc: "Trust is our most important product. From payment verification to financial records, security is the promise we never break.",
    aboutValue3Title: "Designed for Real Conditions",
    aboutValue3Desc: "Our systems keep working on slow connections, speak your users' language and support the payment methods people actually use.",
    aboutValue4Title: "Uncompromising Excellence",
    aboutValue4Desc: "Great software can come from anywhere. We build to international engineering standards and never compromise on quality.",
  ...
  am: {
    ...
    langToggle: "English",
    exploreCompanies: "የምንገነባውን ይመልከቱ",
    startProject: "ፕሮጀክት ይጀምሩ",

    heroTitle: "",
    heroSubtitle: "ከድረገጾች እስከ ሆስፒታል እና ሆቴል አስተዳደር፣ እና ድርጅትዎ ሊያስበው የሚችለው ማንኛውም ስርዓት። በአንድ ቁርጠኛ ቡድን የሚቀረጽ፣ የሚገነባ እና የሚደገፍ።",
    ...
    whyTitle: "በድርጅትዎ አሰራር ዙሪያ የተገነባ",
    whyCard1Title: "የአካባቢ ግንዛቤ፣ ዓለም አቀፍ ደረጃ",
    whyCard1Desc: "በፍጥነት በሚያድጉ ገበያዎች የተቀረጸ፣ በዓለም አቀፍ ደረጃ የተገነባ እና ኢንተርኔት ሲቆራረጥም የሚሰራ።",
    whyCard2Title: "ፈጣን እና ዘመናዊ",
    whyCard2Desc: "ፈጣን እና ሊያድግ በሚችል የደመና መሰረተ ልማት ላይ የሚሰሩ ዘመናዊ እና የተረጋገጡ ቴክኖሎጂዎች።",
    whyCard3Title: "ደህንነቱ የተጠበቀ እና አስተማማኝ",
    whyCard3Desc: "ጠንካራ ምስጠራ፣ ደህንነቱ የተጠበቀ መግቢያ እና አውቶማቲክ ምትኬ መረጃዎን በእያንዳንዱ ደረጃ ይጠብቃሉ።",
    whyCard4Title: "በቋንቋዎ የሚደረግ ድጋፍ",
    whyCard4Desc: "በእንግሊዝኛ እና በአማርኛ በስልክ፣ በኢሜይል እና በቴሌግራም፣ በሁሉም የሰዓት ዞኖች።",

    stat1Label: "የምንሰራባቸው ዘርፎች",
    ...
    test2Text: "\"ከቤዩ ቴክ ያገኘነው የQR ሜኑ ስርዓት ሬስቶራንታችንን ቀይሮታል። ደንበኞች ይወዱታል፣ ማዘዝም በጣም ፈጣን ሆኗል።\"",
    test2Author: "ሳራ መ.፣ የሬስቶራንት ስራ አስኪያጅ፣ ቦሌ",
    test3Text: "\"ቤዩ ቴክ የእቃ ክምችት መቆጣጠሪያ ስርዓታችንን ከመሠረቱ ገንብቶልናል። በጣም ፕሮፌሽናል፣ ፈጣን እና ልክ እንደምንፈልገው ነው።\"",
    test3Author: "ዳዊት ተ.፣ የጅምላ አከፋፋይ",

    contactSectionTitle: "ትልቅ ነገር ለመገንባት ዝግጁ ነዎት?",
    contactSectionSubtitle: "ድረገጽ፣ የሆስፒታል ስርዓት፣ የሆቴል መድረክ ወይም ፍጹም አዲስ ነገር። የሚፈልጉትን ይንገሩን፣ እንገነባዋለን።",
    ...
    contactSuccessMessage: "ስላነጋገሩን እናመሰግናለን። ቡድናችን በ24 ሰዓት ውስጥ ያነጋግርዎታል።",
    contactInfoTitle: "የእውቂያ መረጃ",
    contactTelegram: "ቴሌግራም: @Beutechsupport",
    contactEmail: "ኢሜይል: infobeutech@gmail.com",
    contactLocation: "አዲስ አበባ፣ ኢትዮጵያ",

    aboutStoryTitle: "የእኛ ታሪክ",
    aboutStoryText1: "ቤዩ ቴክ ዲጂታል ሽግግርን ለማፋጠን በአንድ ግልጽ ዓላማ የተመሰረተ የኢትዮጵያ የሶፍትዌር ጀማሪ ድርጅት ነው። ለሁሉም አንድ አይነት ምርት ከመሸጥ ይልቅ እያንዳንዱ ድርጅት የሚፈልገውን አዳምጠን በትክክል እንገነባለን፣ ከድረገጾች እና ከሆስፒታል እና ሆቴል ስርዓቶች እስከ የትምህርት ቤት መድረኮች፣ POS እና ደንበኞቻችን የሚጠይቁትን ማንኛውንም ነገር።",
    aboutStoryText2: "ብቁ የአገር ውስጥ መሐንዲሶችን፣ ዘመናዊ የልማት አሰራሮችን እና ንግዶች በእውነት እንዴት እንደሚሰሩ ጥልቅ ግንዛቤን እናጣምራለን። ከመርካቶ ትናንሽ ነጋዴዎች እስከ አዲስ አበባ ትላልቅ ሆቴሎች ድረስ የምንገነባቸው ስርዓቶች ጠንካራ፣ ደህንነታቸው የተጠበቀ እና ፈጣን ናቸው።",
    aboutMissionTitle: "የእኛ ተልዕኮ",
    aboutMissionText: "ድርጅቶች የትም ቢሆኑ እንዲያድጉ የሚያግዙ አስተማማኝ፣ ሊያድጉ የሚችሉ እና በውበት የተነደፉ ሶፍትዌሮችን መገንባት።",
    aboutVisionTitle: "የእኛ ራዕይ",
    aboutVisionText: "ከቤታችን ከኢትዮጵያ ጀምረን ወደ ውጭ በማደግ፣ ብልጥ እና ደህንነቱ የተጠበቀ ሶፍትዌርን ለእያንዳንዱ ድርጅት ተደራሽ የሚያደርግ ታማኝ የዲጂታል ሽግግር ሞተር ለመሆን እንሰራለን።",
    aboutValuesTitle: "የእኛ እሴቶች",
    aboutValue1Title: "ዓላማ ያለው ፈጠራ",
    aboutValue1Desc: "ቴክኖሎጂን ለራሱ ብለን አንገነባም። እያንዳንዱ የኮድ መስመር ለእውነተኛ ንግድ እውነተኛ ችግር መፍታት አለበት።",
    aboutValue2Title: "ፍጹም ታማኝነት",
    aboutValue2Desc: "እምነት ዋነኛው ምርታችን ነው። ከክፍያ ማረጋገጫ እስከ የፋይናንስ መዛግብት፣ ደህንነት የማናፈርሰው ቃል ኪዳናችን ነው።",
    aboutValue3Title: "ለእውነተኛ ሁኔታ የተነደፈ",
    aboutValue3Desc: "ስርዓቶቻችን በዝግተኛ ኢንተርኔትም ይሰራሉ፣ የተጠቃሚዎችዎን ቋንቋ ይናገራሉ እንዲሁም ሰዎች በእውነት የሚጠቀሙባቸውን የክፍያ መንገዶች ይደግፋሉ።",
    aboutValue4Title: "ያለድርድር ጥራት",
    aboutValue4Desc: "ምርጥ ሶፍትዌር ከየትም ሊመጣ ይችላል። በዓለም አቀፍ የምህንድስና ደረጃ እንገነባለን። በጥራት ላይም አንደራደርም።",
